...
public interface SerializableStrategy {
     ...
     * @throws ClassNotFoundException if the class of the object is not present
     */
     ...
     * @throws IOException if stream is closed or we can't write
     */
     ...
     * open the io-stream
     *
     * @param path the path for the file storage
     * @throws IOException if the stream can't be created
     */
